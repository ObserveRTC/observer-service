...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record6<Integer, byte[], String, byte[], byte[], UsersRole> {
    ...
    private static final long serialVersionUID = -459019331;

    /**
     * Setter for <code>ObserveRTC.Users.id</code>. The identifier of the user for inside relations, never outside
     */
    ...
    /**
     * Getter for <code>ObserveRTC.Users.id</code>. The identifier of the user for inside relations, never outside
     */
    ...
    /**
     * Setter for <code>ObserveRTC.Users.uuid</code>. The UUID of the user published outside 
     */
    ...
    /**
     * Getter for <code>ObserveRTC.Users.uuid</code>. The UUID of the user published outside 
     */
    public byte[] getUuid() {
        return (byte[]) get(1);
    }
    ...
    /**
     * Setter for <code>ObserveRTC.Users.username</code>. The username of the user
     */
    ...
    /**
     * Getter for <code>ObserveRTC.Users.username</code>. The username of the user
     */
    ...
    /**
     * Setter for <code>ObserveRTC.Users.password_digest</code>. The hash of the password using the salt
     */
    ...
    /**
     * Getter for <code>ObserveRTC.Users.password_digest</code>. The hash of the password using the salt
     */
    ...
    /**
     * Setter for <code>ObserveRTC.Users.password_salt</code>. The salt for the password
     */
    ...
    /**
     * Getter for <code>ObserveRTC.Users.password_salt</code>. The salt for the password
     */
    ...
    /**
     * Setter for <code>ObserveRTC.Users.role</code>. The role of the user determines of which endpoint it can access to
     */
    ...
    /**
     * Getter for <code>ObserveRTC.Users.role</code>. The role of the user determines of which endpoint it can access to
     */
