...
public class FinishedCalls {
	private static final Logger logger = LoggerFactory.getLogger(FinishedCalls.class);

	private static final String TABLE_NAME = "FinishedCalls";
	private final WebRTCDataSet webRTCDataSet;
	private final BigQueryService bigQueryService;

	public FinishedCalls(WebRTCDataSet webRTCDataSet, BigQueryService bigQueryService) {
		this.webRTCDataSet = webRTCDataSet;
		this.bigQueryService = bigQueryService;
	}

	public void insert(FinishedCall row) {
