...
public class InboundRTP {
	...
	@JsonProperty("bytesReceived")
	public void setBytesReceived(double value) {
	...
	@JsonProperty("decoderImplementation")
	public void setDecoderImplementation(String value) {
	...
	@JsonProperty("estimatedPlayoutTimestamp")
	public void setEstimatedPlayoutTimestamp(double value) {
		this.estimatedPlayoutTimestamp = value;
	}

	@JsonProperty("fecPacketsDiscarded")
	public double getFECPacketsDiscarded() {
		return fecPacketsDiscarded;
	}

	@JsonProperty("fecPacketsDiscarded")
	public void setFECPacketsDiscarded(double value) {
		this.fecPacketsDiscarded = value;
	}

	@JsonProperty("fecPacketsReceived")
	public double getFECPacketsReceived() {
		return fecPacketsReceived;
	}

	@JsonProperty("fecPacketsReceived")
	public void setFECPacketsReceived(double value) {
		this.fecPacketsReceived = value;
	}

	@JsonProperty("firCount")
	public double getFirCount() {
		return firCount;
	}

	@JsonProperty("firCount")
	public void setFirCount(double value) {
		this.firCount = value;
	}
	...
	@JsonProperty("framesDecoded")
	public void setFramesDecoded(double value) {
		this.framesDecoded = value;
	}

	@JsonProperty("headerBytesReceived")
	public double getHeaderBytesReceived() {
		return headerBytesReceived;
	}

	@JsonProperty("headerBytesReceived")
	public void setHeaderBytesReceived(double value) {
	...
	public double getKeyFramesDecoded() {
		return keyFramesDecoded;
	}

	@JsonProperty("keyFramesDecoded")
	public void setKeyFramesDecoded(double value) {
	...
	@JsonProperty("lastPacketReceivedTimestamp")
	public void setLastPacketReceivedTimestamp(double value) {
		this.lastPacketReceivedTimestamp = value;
	}

	@JsonProperty("mediaType")
	public Kind getMediaType() {
		return mediaType;
	}

	@JsonProperty("mediaType")
	public void setMediaType(Kind value) {
	...
	@JsonProperty("nackCount")
	public void setNACKCount(double value) {
	...
	@JsonProperty("packetsLost")
	public void setPacketsLost(double value) {
	...
	public double getPliCount() {
		return pliCount;
	}

	@JsonProperty("pliCount")
	public void setPliCount(double value) {
		this.pliCount = value;
	}
	...
	@JsonProperty("qpSum")
	public void setQpSum(double value) {
		this.qpSum = value;
	}

	@JsonProperty("ssrc")
	public double getSsrc() {
		return ssrc;
	}

	@JsonProperty("ssrc")
	public void setSsrc(double value) {
		this.ssrc = value;
	}
	...
	@JsonProperty("totalDecodeTime")
	public void setTotalDecodeTime(double value) {
	...
	@JsonProperty("totalInterFrameDelay")
	public void setTotalInterFrameDelay(double value) {
	...
	@JsonProperty("totalSquaredInterFrameDelay")
	public void setTotalSquaredInterFrameDelay(double value) {
	...
	@JsonProperty("type")
	public InboundRTPType getType() {
		return type;
	}

	@JsonProperty("type")
	public void setType(InboundRTPType value) {
		this.type = value;
	}
}
