...
public class OrganisationsRecord extends UpdatableRecordImpl<OrganisationsRecord> implements Record4<Integer, byte[], String, String> {
    ...
    private static final long serialVersionUID = -39436207;

    /**
     * Setter for <code>WebRTCObserver.Organisations.id</code>. The identifier of the organization for inside relations, never outside
     */
    ...
    /**
     * Getter for <code>WebRTCObserver.Organisations.id</code>. The identifier of the organization for inside relations, never outside
     */
    ...
    /**
     * Setter for <code>WebRTCObserver.Organisations.uuid</code>. The UUID of the organization published outside 
     */
    ...
    /**
     * Getter for <code>WebRTCObserver.Organisations.uuid</code>. The UUID of the organization published outside 
     */
    public byte[] getUuid() {
        return (byte[]) get(1);
    }
    ...
    /**
     * Setter for <code>WebRTCObserver.Organisations.name</code>. The name of the organization
     */
    ...
    /**
     * Getter for <code>WebRTCObserver.Organisations.name</code>. The name of the organization
     */
    ...
    /**
     * Setter for <code>WebRTCObserver.Organisations.description</code>. The description for the organization
     */
    ...
    /**
     * Getter for <code>WebRTCObserver.Organisations.description</code>. The description for the organization
     */
