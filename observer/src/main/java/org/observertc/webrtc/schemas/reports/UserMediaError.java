...
public class UserMediaError extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public UserMediaError(String mediaUnitId, String callName, String userId, String browserId, String peerConnectionUUID, String message) {
   ...
   */
  public static UserMediaError.Builder newBuilder() {
    return new UserMediaError.Builder();
  }
   ...
   * @return A new UserMediaError RecordBuilder
   */
  public static UserMediaError.Builder newBuilder(UserMediaError.Builder other) {
    if (other == null) {
      return new UserMediaError.Builder();
    } else {
      return new UserMediaError.Builder(other);
    }
  }
   ...
   * @return A new UserMediaError RecordBuilder
   */
  public static UserMediaError.Builder newBuilder(UserMediaError other) {
    if (other == null) {
      return new UserMediaError.Builder();
    } else {
      return new UserMediaError.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserMediaError>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(UserMediaError.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(UserMediaError other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.mediaUnitId)) {
        this.mediaUnitId = data().deepCopy(fields()[0].schema(), other.mediaUnitId);
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder setMediaUnitId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder clearMediaUnitId() {
      mediaUnitId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder setCallName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder clearCallName() {
      callName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder setUserId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder setBrowserId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder clearBrowserId() {
      browserId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder setPeerConnectionUUID(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder clearPeerConnectionUUID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder setMessage(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserMediaError.Builder clearMessage() {
      message = null;
    ...
    public UserMediaError build() {
      try {
        ...
        record.message = fieldSetFlags()[5] ? this.message : (String) defaultValue(fields()[5]);
        return record;
