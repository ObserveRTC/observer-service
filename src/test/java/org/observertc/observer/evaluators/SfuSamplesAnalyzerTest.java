...
class SfuSamplesAnalyzerTest {
    ...
    void shouldCreateReports() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        this.sfuSamplesAnalyzer.observableReports().subscribe(reportsPromise::complete);
        this.sfuSamplesAnalyzer.accept(observedSfuSamples);
