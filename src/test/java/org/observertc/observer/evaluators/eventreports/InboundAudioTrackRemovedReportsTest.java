...
@MicronautTest
class InboundAudioTrackRemovedReportsTest {
    ...
    void shouldHasExpectedValuesWhenRemoved() throws Throwable {
        ...
        var reports = this.inboundAudioTrackRemovedReports.mapRemovedMediaTracks(List.of(expected));
    ...
    void shouldHasExpectedValuesWhenExpired_1() throws Throwable {
        ...
        var reports = this.inboundAudioTrackRemovedReports.mapExpiredMediaTracks(List.of(expired));
        var actual = reports.get(0);
