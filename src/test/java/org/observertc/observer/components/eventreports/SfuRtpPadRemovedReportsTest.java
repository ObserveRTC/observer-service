...
class SfuRtpPadRemovedReportsTest {
    ...
    void shouldHasExpectedValuesWhenRemoved() throws Throwable {
        ...
        var reports = this.sfuRtpPadRemovedReports.mapDisposedSfuRtpPads(List.of(expected));
        ...
        Assertions.assertEquals(expected.timestamp, actual.timestamp, "timestamp field");
