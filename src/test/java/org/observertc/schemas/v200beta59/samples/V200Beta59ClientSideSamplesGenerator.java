...
public class V200Beta59ClientSideSamplesGenerator implements Supplier<Samples> {
    ...
    public V200Beta59ClientSideSamplesGenerator setClientId(UUID value) {
        this.clientId = value;
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator setCallId(UUID value) {
        this.clientId = value;
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator setRoomId(String value) {
        this.roomId = value;
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator setRemoteClientId(String value) {
        this.remoteClientId = value;
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator setUserId(String value) {
        this.userId = value;
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator setMarker(String value) {
        this.marker = value;
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator setTimeZoneOffsetInHours(Integer value) {
        this.timeZoneOffsetInHours = value;
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addBrowser() {
    ...
    public V200Beta59ClientSideSamplesGenerator addEngine() {
    ...
    public V200Beta59ClientSideSamplesGenerator addPlatform() {
    ...
    public V200Beta59ClientSideSamplesGenerator addMediaSource() {
    ...
    public V200Beta59ClientSideSamplesGenerator addOperationSystem() {
    ...
    public V200Beta59ClientSideSamplesGenerator addMediaDevice() {
    ...
    public V200Beta59ClientSideSamplesGenerator addExtensionStat() {
    ...
    public V200Beta59ClientSideSamplesGenerator addMediaCodec() {
    ...
    public V200Beta59ClientSideSamplesGenerator addCertificate() {
    ...
    public V200Beta59ClientSideSamplesGenerator addIceLocalCandidate() {
    ...
    public V200Beta59ClientSideSamplesGenerator addIceRemoteCandidate() {
    ...
    public V200Beta59ClientSideSamplesGenerator addUserMediaError(String value) {
        this.addedUserMediaErrors.add(value);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addLocalSdp(String value) {
        this.addedLocalSDP.add(value);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addMediaConstraint(String value) {
        this.addedMediaConstraints.add(value);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addIceServer(String value) {
        this.addedIceServers.add(value);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addPeerConnection(UUID value) {
        this.peerConnectionIds.add(value);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator removePeerConnection(UUID value) {
    ...
    public V200Beta59ClientSideSamplesGenerator addDataChannel(UUID peerConnectionId, UUID channelId) {
    ...
    public V200Beta59ClientSideSamplesGenerator addInboundAudioTrack(UUID peerConnectionId, UUID trackId, Long SSRC) {
        return this.addInboundAudioTrack(peerConnectionId, trackId, SSRC, null, null);
    }

    public V200Beta59ClientSideSamplesGenerator addInboundAudioTrack(UUID peerConnectionId, UUID trackId, Long SSRC, UUID sfuStreamId, UUID sfuSinkId) {
    ...
    public V200Beta59ClientSideSamplesGenerator removeInboundAudioTrack(UUID trackId) {
        this.inboundAudioTracks.remove(trackId);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addInboundVideoTrack(UUID peerConnectionId, UUID trackId, Long SSRC) {
        return this.addInboundVideoTrack(peerConnectionId, trackId, SSRC, null, null);
    }

    public V200Beta59ClientSideSamplesGenerator addInboundVideoTrack(UUID peerConnectionId, UUID trackId, Long SSRC, UUID sfuStreamId, UUID sfuSinkId) {
        if (!this.peerConnectionIds.contains(peerConnectionId)) {
            throw new RuntimeException("Add the peer connection id to the generator before you add any session related to it");
        }
        var rtpSession = new RtpSession(sfuStreamId, sfuSinkId, SSRC, peerConnectionId);
    ...
    public V200Beta59ClientSideSamplesGenerator removeInboundVideoTrack(UUID trackId) {
        this.outboundVideoTracks.remove(trackId);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addOutboundAudioTrack(UUID peerConnectionId, UUID trackId, Long SSRC) {
        return this.addOutboundAudioTrack(peerConnectionId, trackId, SSRC, null);
    }

    public V200Beta59ClientSideSamplesGenerator addOutboundAudioTrack(UUID peerConnectionId, UUID trackId, Long SSRC, UUID sfuStreamId) {
        if (!this.peerConnectionIds.contains(peerConnectionId)) {
            throw new RuntimeException("Add the peer connection id to the generator before you add any session related to it");
        }
    ...
    public V200Beta59ClientSideSamplesGenerator removeOutboundAudioTrack(UUID trackId) {
        this.outboundAudioTracks.remove(trackId);
        return this;
    }

    public V200Beta59ClientSideSamplesGenerator addOutboundVideoTrack(UUID peerConnectionId, UUID trackId, Long SSRC) {
        return this.addOutboundVideoTrack(peerConnectionId, trackId, SSRC, null);
    }

    public V200Beta59ClientSideSamplesGenerator addOutboundVideoTrack(UUID peerConnectionId, UUID trackId, Long SSRC, UUID sfuStreamId) {
        if (!this.peerConnectionIds.contains(peerConnectionId)) {
            throw new RuntimeException("Add the peer connection id to the generator before you add any session related to it");
        }
        var rtpSession = new RtpSession(sfuStreamId, null, SSRC, peerConnectionId);
    ...
    public V200Beta59ClientSideSamplesGenerator removeOutboundVideoTrack(UUID trackId) {
        this.outboundVideoTracks.remove(trackId);
        return this;
    }
