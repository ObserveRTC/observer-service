...
public class V200Beta59SfuSideSamplesGenerator implements Supplier<Samples> {
    ...
    public V200Beta59SfuSideSamplesGenerator setSfuId(UUID value) {
        this.sfuId = value;
        return this;
    }

    public V200Beta59SfuSideSamplesGenerator setMarker(String value) {
        this.marker = value;
        return this;
    }

    public V200Beta59SfuSideSamplesGenerator setTimeZoneOffsetInHours(Integer value) {
        this.timeZoneOffsetInHours = value;
        return this;
    }

    public V200Beta59SfuSideSamplesGenerator addExtensionStat() {
    ...
    public V200Beta59SfuSideSamplesGenerator addTransport(UUID value) {
        return this.addTransport(value, false);
    }

    public V200Beta59SfuSideSamplesGenerator addTransport(UUID value, boolean internal) {
        var session = new TransportSession(internal);
        this.transports.put(value, session);
        return this;
    }

    public V200Beta59SfuSideSamplesGenerator removeTransport(UUID value) {
    ...
    public V200Beta59SfuSideSamplesGenerator addDataChannel(UUID transportId, UUID streamId, UUID channelId) {
        var session = new DataChannelSession(transportId, streamId);
        this.sctpChannels.put(channelId, session);
        return this;
    }

    public V200Beta59SfuSideSamplesGenerator removeDataChannel(UUID channelId) {
        this.sctpChannels.remove(channelId);
        return this;
    }

    public V200Beta59SfuSideSamplesGenerator addInboundRtpPad(UUID transportId, UUID rtpPadId, Long SSRC, UUID sfuStreamId) {
        return this.addInboundRtpPad(transportId, rtpPadId, SSRC, sfuStreamId, false);
    }

    public V200Beta59SfuSideSamplesGenerator addInboundRtpPad(UUID transportId, UUID rtpPadId, Long SSRC, UUID sfuStreamId, boolean internal) {
    ...
    public V200Beta59SfuSideSamplesGenerator removeInboundRtpPad(UUID rtpPadId) {
        this.inboundRtpPads.remove(rtpPadId);
        return this;
    }

    public V200Beta59SfuSideSamplesGenerator addOutboundRtpPad(UUID transportId, UUID rtpPadId, Long SSRC, UUID sfuStreamId, UUID sfuSinkId)  {
        return this.addOutboundRtpPad(transportId, rtpPadId, SSRC, sfuStreamId, sfuSinkId, false);
    }
    public V200Beta59SfuSideSamplesGenerator addOutboundRtpPad(UUID transportId, UUID rtpPadId, Long SSRC, UUID sfuStreamId, UUID sfuSinkId, boolean internal) {
        return this.addOutboundRtpPad(transportId, rtpPadId, SSRC, sfuStreamId, sfuSinkId, internal, null, null);
    }


    public V200Beta59SfuSideSamplesGenerator addOutboundRtpPad(UUID transportId, UUID rtpPadId, Long SSRC, UUID sfuStreamId, UUID sfuSinkId, boolean internal, UUID remoteClientId, UUID remoteTrackId) {
        if (!this.transports.containsKey(transportId)) {
            throw new RuntimeException("Add the peer connection id to the generator before you add any session related to it");
        }
    ...
    public V200Beta59SfuSideSamplesGenerator removeOutboundRtpPad(UUID rtpPadId) {
