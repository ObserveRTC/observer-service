...
public class Fromv210ToLatestConverter implements Function<org.observertc.schemas.v210.samples.Samples, org.observertc.schemas.samples.Samples> {

    @Override
    public org.observertc.schemas.samples.Samples apply(org.observertc.schemas.v210.samples.Samples source) throws Throwable {
    ...
    private org.observertc.schemas.samples.Samples.ClientSample[] getClientSamples(org.observertc.schemas.v210.samples.Samples.ClientSample[] srcClientSamples) {
        ...
        for (int index = 0; index < srcClientSamples.length; ++index) {
            ...
            if (srcClientSample.iceCandidatePairs != null) {
                var srcIceCandidatePairs = srcClientSample.iceCandidatePairs;
                var dstIceCandidatePairs = new org.observertc.schemas.samples.Samples.ClientSample.IceCandidatePair[srcIceCandidatePairs.length];
                for (int j = 0; j < dstIceCandidatePairs.length; ++j) {
                    var srcIceCandidatePair = srcIceCandidatePairs[j];
                    var dstIceCandidatePair = new org.observertc.schemas.samples.Samples.ClientSample.IceCandidatePair();
                    dstIceCandidatePair.candidatePairId = srcIceCandidatePair.candidatePairId;
                    dstIceCandidatePair.peerConnectionId = srcIceCandidatePair.peerConnectionId;
                    dstIceCandidatePair.label = srcIceCandidatePair.label;
                    dstIceCandidatePair.transportId = srcIceCandidatePair.transportId;
                    dstIceCandidatePair.localCandidateId = srcIceCandidatePair.localCandidateId;
                    dstIceCandidatePair.remoteCandidateId = srcIceCandidatePair.remoteCandidateId;
                    dstIceCandidatePair.state = srcIceCandidatePair.state;
                    dstIceCandidatePair.nominated = srcIceCandidatePair.nominated;
                    dstIceCandidatePair.packetsSent = srcIceCandidatePair.packetsSent;
                    dstIceCandidatePair.packetsReceived = srcIceCandidatePair.packetsReceived;
                    dstIceCandidatePair.bytesSent = srcIceCandidatePair.bytesSent;
                    dstIceCandidatePair.bytesReceived = srcIceCandidatePair.bytesReceived;
                    dstIceCandidatePair.lastPacketSentTimestamp = srcIceCandidatePair.lastPacketSentTimestamp;
                    dstIceCandidatePair.lastPacketReceivedTimestamp = srcIceCandidatePair.lastPacketReceivedTimestamp;
                    dstIceCandidatePair.totalRoundTripTime = srcIceCandidatePair.totalRoundTripTime;
                    dstIceCandidatePair.currentRoundTripTime = srcIceCandidatePair.currentRoundTripTime;
                    dstIceCandidatePair.availableOutgoingBitrate = srcIceCandidatePair.availableOutgoingBitrate;
                    dstIceCandidatePair.availableIncomingBitrate = srcIceCandidatePair.availableIncomingBitrate;
                    dstIceCandidatePair.requestsReceived = srcIceCandidatePair.requestsReceived;
                    dstIceCandidatePair.requestsSent = srcIceCandidatePair.requestsSent;
                    dstIceCandidatePair.responsesReceived = srcIceCandidatePair.responsesReceived;
                    dstIceCandidatePair.responsesSent = srcIceCandidatePair.responsesSent;
                    dstIceCandidatePair.consentRequestsSent = srcIceCandidatePair.consentRequestsSent;
                    dstIceCandidatePair.packetsDiscardedOnSend = srcIceCandidatePair.packetsDiscardedOnSend;
                    dstIceCandidatePair.bytesDiscardedOnSend = srcIceCandidatePair.bytesDiscardedOnSend;
                    dstIceCandidatePairs[j] = dstIceCandidatePair;
                }
            }
    ...
    private org.observertc.schemas.samples.Samples.SfuSample[] getSfuSamples(org.observertc.schemas.v210.samples.Samples.SfuSample[] srcSfuSamples) {
