...
public class OutboundReportsAvroEncoder implements Encoder{
    ...
    public OutboundReportsAvroEncoder() {
        ...
        this.sfuInboundRtpPadEncoder = new BinaryMessageEncoder<SfuInboundRtpPadReport>(SpecificData.get(), SfuInboundRtpPadReport.getClassSchema());
        this.sfuOutboundRtpPadEncoder = new BinaryMessageEncoder<SfuOutboundRtpPadReport>(SpecificData.get(), SfuOutboundRtpPadReport.getClassSchema());
