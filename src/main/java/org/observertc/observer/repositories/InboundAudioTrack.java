...
public class InboundAudioTrack {

    private final PeerConnectionsRepository peerConnectionsRepository;
    private final AtomicReference<Models.InboundAudioTrack> modelHolder;
    private final InboundAudioTracksRepository inboundAudioTracksRepository;

    InboundAudioTrack(PeerConnectionsRepository peerConnectionsRepository,
                      Models.InboundAudioTrack model,
    ...
    public void addSSRC(Long ssrc) {
        ...
        var newModel = Models.InboundAudioTrack.newBuilder(model)
                .addSsrc(ssrc)
                .build();
    ...
    private void updateModel(Models.InboundAudioTrack newModel) {
        this.modelHolder.set(newModel);
        this.inboundAudioTracksRepository.update(newModel);
    }
}
