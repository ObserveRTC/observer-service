...
@Singleton
public class SfuSctpStreamAddedReports {

    private static final Logger logger = LoggerFactory.getLogger(SfuSctpStreamAddedReports.class);
...
//                    .setCallId(callId)
                    ...
                    .setMessage("Sfu SCTP stream is added")
                    ...
                    ;
            logger.info("SFU SCTP Stream (id: {}) is ADDED (mediaUnitId: {}, serviceId {}).",
