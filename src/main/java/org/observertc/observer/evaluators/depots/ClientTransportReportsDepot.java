    ...
    public void assemble() {
        try {
            ...
            var report = ClientTransportReport.newBuilder()
                    ...
                    .setCandidatePairBytesReceived(peerConnectionTransport.candidatePairBytesReceived)
                    ...
                    .setCandidatePairLastResponseTimestamp(peerConnectionTransport.candidatePairLastResponseTimestamp)
                    ...
                    .setCandidatePairAvailableIncomingBitrate(peerConnectionTransport.candidatePairAvailableIncomingBitrate)
                    ...
                    .setCandidatePairResponsesSent(peerConnectionTransport.candidatePairResponsesSent)
