...
public interface ObservedOutboundVideoTrack extends Iterable<Samples.ClientSample.OutboundVideoTrack> {
    ...
    class Builder implements ObservedOutboundVideoTrack {
        private final String trackId;
        private final ObservedPeerConnection.Builder observedPeerConnection;
        private List<Samples.ClientSample.OutboundVideoTrack> outboundAudioTrackSamples = new LinkedList<>();
        ...
        public void add(Samples.ClientSample.OutboundVideoTrack outboundVideoTrackSample) {
            this.outboundAudioTrackSamples.add(outboundVideoTrackSample);
        }
        ...
        @NotNull
        @Override
        public Iterator<Samples.ClientSample.OutboundVideoTrack> iterator() {
