...
public class SinkAssembler extends AbstractBuilder {
    private static final Logger logger = LoggerFactory.getLogger(SinkAssembler.class);
    private final List<String> packages;
    private SinkBuilder.Essentials essentials = null;

    public SinkAssembler() {
    ...
    public void setEssentials(SinkBuilder.Essentials essentials) {
