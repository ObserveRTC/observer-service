...
//import org.observertc.webrtc.observer.evaluators.pcSampleToReportsV2.valueadapters.EnumConverter;
//import org.observertc.webrtc.observer.evaluators.pcSampleToReportsV2.valueadapters.NumberConverter;
...
//
//@Singleton
//public class ObservedPcStatesEvaluator implements Observer<ObservedPcState> {
//
//    private static final Logger logger = LoggerFactory.getLogger(ObservedPcStatesEvaluator.class);
//
//    private final Subject<ClientMetaReport> clientMetaReports = PublishSubject.create();
//    private final Subject<InboundAudioTrackReport> inboundAudioTrackReports = PublishSubject.create();
//    private final Subject<InboundVideoTrackReport> inboundVideoTrackReports = PublishSubject.create();
//    private final Subject<OutboundAudioTrackReport> outboundAudioTrackReports = PublishSubject.create();
//    private final Subject<OutboundVideoTrackReport> outboundVideoTrackReports = PublishSubject.create();
//    private final Subject<PcTransportReport> pcTransportReports = PublishSubject.create();
//    private final Subject<PcMetaReport> pcMetaReports = PublishSubject.create();
//    private final Subject<PcDataChannelReport> pcDataChannelReports = PublishSubject.create();
//
...
//
//    private Map<Long, InbATrackTuple> inbATrackTuples = new HashMap<>();
//    private Map<Long, InbVTrackTuple> inbVTrackTuples = new HashMap<>();
//    private Map<Long, OutbATrackTuple> outbATrackTuples = new HashMap<>();
//    private Map<Long, OutbVTrackTuple> outbVTrackTuples = new HashMap<>();
//    private UUID actualCallUUID;
//
//    @Inject
...
//
//    public ObservedPcStatesEvaluator(IPAddressConverterProvider ipAddressConverterProvider) {
...
//    }
//
//    public Observable<InboundAudioTrackReport> getInboundAudioTrackReports() {
//        return inboundAudioTrackReports;
//    }
//
//    public Observable<InboundVideoTrackReport> getInboundVideoTrackReports() {
//        return inboundVideoTrackReports;
//    }
//
//    public Observable<OutboundAudioTrackReport> getOutboundAudioTrackReports() {
//        return outboundAudioTrackReports;
//    }
//
//    public Observable<OutboundVideoTrackReport> getOutboundVideoTrackReports() {
//        return outboundVideoTrackReports;
//    }
//
//    public Observable<PcTransportReport> getPcTransportReports() {
//        return pcTransportReports;
//    }
//
//    public Observable<PcMetaReport> getPcMetaReports() {
//        return pcMetaReports;
//    }
//
//    public Observable<PcDataChannelReport> getPcDataChannelReports() {
//        return pcDataChannelReports;
//    }
//
//    @Override
...
//    }
//
//    private Consumer<ObservedPCS> makeProcessor() {
//        PeerConnectionSampleVisitor<ObservedPCS> preProcessor = makePreProcessor();
//        return new Consumer<ObservedPCS>() {
//            @Override
//            public void accept(ObservedPCS observedPCS) throws Throwable {
//                preProcessor.accept(observedPCS, observedPCS.peerConnectionSample);
//
//                // now we can push the other reports as well
//            }
//        };
//    }
//
//    private PeerConnectionSampleVisitor<ObservedPCS> makePreProcessor() {
...
//            var reportMaker = (payloadType, mapObj) -> {
//                var clientMetaReport = ClientMetaReport.newBuilder()
//                        .setCallUUID()
//                        .setMarker()
//                        .setClientId()
//                        .setMediaUnitId()
...
//                        .setUserId()
//                        .build();
//                clientMetaReports.onNext(clientMetaReport);
//            }
//            var report = ClientMetaReport.newBuilder()
//                    .setClientId(peerConnectionSample.browserId)
//                    .setRoomName(peerConnectionSample.callId)
...
//                case AUDIO:
//                    var audioTuple = this.outbATrackTuples.getOrDefault(subject.ssrc, new OutbATrackTuple());
//                    audioTuple.observedPCS = observedPCS;
//                    audioTuple.outboundRTPStreamStats = subject;
//                    break;
//                case VIDEO:
//                    var videoTuple = this.outbVTrackTuples.getOrDefault(subject.ssrc, new OutbVTrackTuple());
//                    videoTuple.observedPCS = observedPCS;
//                    videoTuple.outboundRTPStreamStats = subject;
//                    break;
//                default:
//                case UNKNOWN:
//                    logger.warn("Media Type for observed pcs {} is unknown", observedPCS.toString());
//                    break;
//            }
//            PeerConnectionSample peerConnectionSample = observedPCS.peerConnectionSample;
...
//
//
//    class InbATrackTuple {
//        public ObservedPCS observedPCS;
//        public PeerConnectionSample.InboundRTPStreamStats inboundRTPStreamStats;
//        public PeerConnectionSample.RemoteInboundRTPStreamStats remoteInboundRTPStreamStats;
//    }
//
//    class InbVTrackTuple {
//        public ObservedPCS observedPCS;
//        public PeerConnectionSample.InboundRTPStreamStats inboundRTPStreamStats;
//        public PeerConnectionSample.RemoteInboundRTPStreamStats remoteInboundRTPStreamStats;
//    }
//
//    class OutbATrackTuple {
//        public ObservedPCS observedPCS;
//        public PeerConnectionSample.OutboundRTPStreamStats outboundRTPStreamStats;
//    }
//
//    class OutbVTrackTuple {
//        public ObservedPCS observedPCS;
//        public PeerConnectionSample.OutboundRTPStreamStats outboundRTPStreamStats;
//    }
//}
