...
public class FinishedCall extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FinishedCall(String callUUID, String callName) {
   ...
   */
  public static FinishedCall.Builder newBuilder() {
    return new FinishedCall.Builder();
  }
   ...
   * @return A new FinishedCall RecordBuilder
   */
  public static FinishedCall.Builder newBuilder(FinishedCall.Builder other) {
    if (other == null) {
      return new FinishedCall.Builder();
    } else {
      return new FinishedCall.Builder(other);
    }
  }
   ...
   * @return A new FinishedCall RecordBuilder
   */
  public static FinishedCall.Builder newBuilder(FinishedCall other) {
    if (other == null) {
      return new FinishedCall.Builder();
    } else {
      return new FinishedCall.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FinishedCall>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(FinishedCall.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public FinishedCall.Builder setCallUUID(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FinishedCall.Builder clearCallUUID() {
      callUUID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public FinishedCall.Builder setCallName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public FinishedCall.Builder clearCallName() {
      callName = null;
