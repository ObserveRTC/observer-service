...
public class ICELocalCandidate extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public ICELocalCandidate(String mediaUnitId, String callName, String userId, String browserId, String peerConnectionUUID, String candidateId, CandidateType candidateType, Boolean deleted, String ipLSH, Boolean isRemote, NetworkType networkType, Integer port, TransportProtocol protocol, Long priority, String transportID) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 6: candidateType = (CandidateType)value$; break;
    case 7: deleted = (Boolean)value$; break;
    case 8: ipLSH = value$ != null ? value$.toString() : null; break;
    case 9: isRemote = (Boolean)value$; break;
    case 10: networkType = (NetworkType)value$; break;
    case 11: port = (Integer)value$; break;
    case 12: protocol = (TransportProtocol)value$; break;
   ...
   */
  public static ICELocalCandidate.Builder newBuilder() {
    return new ICELocalCandidate.Builder();
  }
   ...
   * @return A new ICELocalCandidate RecordBuilder
   */
  public static ICELocalCandidate.Builder newBuilder(ICELocalCandidate.Builder other) {
    if (other == null) {
      return new ICELocalCandidate.Builder();
    } else {
      return new ICELocalCandidate.Builder(other);
    }
  }
   ...
   * @return A new ICELocalCandidate RecordBuilder
   */
  public static ICELocalCandidate.Builder newBuilder(ICELocalCandidate other) {
    if (other == null) {
      return new ICELocalCandidate.Builder();
    } else {
      return new ICELocalCandidate.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ICELocalCandidate>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ICELocalCandidate.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ICELocalCandidate other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.mediaUnitId)) {
        this.mediaUnitId = data().deepCopy(fields()[0].schema(), other.mediaUnitId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setMediaUnitId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearMediaUnitId() {
      mediaUnitId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setCallName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearCallName() {
      callName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setUserId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setBrowserId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearBrowserId() {
      browserId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setPeerConnectionUUID(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearPeerConnectionUUID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setCandidateId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearCandidateId() {
      candidateId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setCandidateType(CandidateType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearCandidateType() {
      candidateType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setDeleted(Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearDeleted() {
      deleted = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setIpLSH(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearIpLSH() {
      ipLSH = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setIsRemote(Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearIsRemote() {
      isRemote = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setNetworkType(NetworkType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearNetworkType() {
      networkType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setPort(Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearPort() {
      port = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setProtocol(TransportProtocol value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearProtocol() {
      protocol = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setPriority(Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearPriority() {
      priority = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder setTransportID(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ICELocalCandidate.Builder clearTransportID() {
      transportID = null;
    ...
    public ICELocalCandidate build() {
      try {
        ...
        record.candidateId = fieldSetFlags()[5] ? this.candidateId : (String) defaultValue(fields()[5]);
        record.candidateType = fieldSetFlags()[6] ? this.candidateType : (CandidateType) defaultValue(fields()[6]);
        record.deleted = fieldSetFlags()[7] ? this.deleted : (Boolean) defaultValue(fields()[7]);
        record.ipLSH = fieldSetFlags()[8] ? this.ipLSH : (String) defaultValue(fields()[8]);
        record.isRemote = fieldSetFlags()[9] ? this.isRemote : (Boolean) defaultValue(fields()[9]);
        record.networkType = fieldSetFlags()[10] ? this.networkType : (NetworkType) defaultValue(fields()[10]);
        record.port = fieldSetFlags()[11] ? this.port : (Integer) defaultValue(fields()[11]);
        record.protocol = fieldSetFlags()[12] ? this.protocol : (TransportProtocol) defaultValue(fields()[12]);
        record.priority = fieldSetFlags()[13] ? this.priority : (Long) defaultValue(fields()[13]);
        record.transportID = fieldSetFlags()[14] ? this.transportID : (String) defaultValue(fields()[14]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.candidateType = CandidateType.values()[in.readEnum()];
      ...
      this.networkType = NetworkType.values()[in.readEnum()];
      ...
      this.protocol = TransportProtocol.values()[in.readEnum()];
