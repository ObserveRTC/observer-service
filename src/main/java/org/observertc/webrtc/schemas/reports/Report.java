...
public class Report extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Report(Integer version, String serviceUUID, String serviceName, String marker, Long timestamp, Object payload, ReportType type) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 6: type = (ReportType)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new Report RecordBuilder
   */
  public static Builder newBuilder(Report other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Report>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setServiceUUID(String value) {
    ...
    public Report build() {
      try {
        ...
        record.serviceUUID = fieldSetFlags()[1] ? this.serviceUUID : (String) defaultValue(fields()[1]);
        record.serviceName = fieldSetFlags()[2] ? this.serviceName : (String) defaultValue(fields()[2]);
        ...
        record.type = fieldSetFlags()[6] ? this.type : (ReportType) defaultValue(fields()[6]);
        return record;
