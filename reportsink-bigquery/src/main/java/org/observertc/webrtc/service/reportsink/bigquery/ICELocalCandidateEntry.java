...
public class ICELocalCandidateEntry implements BigQueryEntry {
	...
	private ICELocalCandidateEntry withDeleted(Boolean value) {
		this.values.put(DELETED_FIELD_NAME, value);
		return this;
	}

	private ICELocalCandidateEntry withIPLSH(String value) {
		this.values.put(IP_LSH_FIELD_NAME, value);
		return this;
	}

	private ICELocalCandidateEntry withNetworkType(NetworkType value) {
	...
	private ICELocalCandidateEntry withPort(Integer value) {
		this.values.put(PORT_FIELD_NAME, value);
		return this;
	}

	private ICELocalCandidateEntry withPriority(Long value) {
		this.values.put(PRIORITY_FIELD_NAME, value);
		return this;
	}

	private ICELocalCandidateEntry withProtocol(ProtocolType value) {
