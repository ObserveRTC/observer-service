...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = 2002373829;

    /**
     * The reference instance of <code>ObserveRTC.Users</code>
     */
    ...
    /**
     * The column <code>ObserveRTC.Users.id</code>. The identifier of the user for inside relations, never outside
     */
    ...
    /**
     * The column <code>ObserveRTC.Users.uuid</code>. The UUID of the user published outside 
     */
    ...
    /**
     * The column <code>ObserveRTC.Users.username</code>. The username of the user
     */
    ...
    /**
     * The column <code>ObserveRTC.Users.password_digest</code>. The hash of the password using the salt
     */
    ...
    /**
     * The column <code>ObserveRTC.Users.password_salt</code>. The salt for the password
     */
    ...
    /**
     * The column <code>ObserveRTC.Users.role</code>. The role of the user determines of which endpoint it can access to
     */
    public final TableField<UsersRecord, UsersRole> ROLE = createField(DSL.name("role"), org.jooq.impl.SQLDataType.VARCHAR(13).nullable(false).asEnumDataType(com.observertc.gatekeeper.jooq.enums.UsersRole.class), this, "The role of the user determines of which endpoint it can access to");

    /**
     * Create a <code>ObserveRTC.Users</code> table reference
     */
    public Users() {
    ...
    /**
     * Create an aliased <code>ObserveRTC.Users</code> table reference
     */
