...
class StatsParser extends index_1.WobserverPlugin {
    constructor() {
        super(...arguments);
        this.optionals = ['certificate', 'codec', 'transport'];
    }
    execute(wobserverPC) {
        return __awaiter(this, void 0, void 0, function* () {
            const [receiverStats, senderStats] = yield Promise.all([
    ...
    receiverStats(pc) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return statsList.filter((item) => !this.optionals.includes(item === null || item === void 0 ? void 0 : item.type));
        });
    }
    senderStats(pc) {
        return __awaiter(this, void 0, void 0, function* () {
...
class StatsSender extends index_1.WobserverPlugin {
    ...
    sendMessage(payload) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            wobserver_logger_1.default.warn('sending message to server', payload);
            (_a = this.webSocket) === null || _a === void 0 ? void 0 : _a.send(JSON.stringify(payload));
        });
    }
}
