...
Object.defineProperty(exports, "__esModule", { value: true });
const wobserver_core_1 = __importDefault(__webpack_require__(/*! ./wobserver.core */ "./build/wobserver.core/index.js"));
const stats_parser_1 = __importDefault(__webpack_require__(/*! ./wobserver.plugins/stats.parser */ "./build/wobserver.plugins/stats.parser/index.js"));
const stats_sender_1 = __importDefault(__webpack_require__(/*! ./wobserver.plugins/stats.sender */ "./build/wobserver.plugins/stats.sender/index.js"));
exports.default = { init: wobserver_core_1.default, StatsParser: stats_parser_1.default, StatsSender: stats_sender_1.default };
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./build/wobserver.core/index.js":
/*!***************************************!*\
  !*** ./build/wobserver.core/index.js ***!
  \***************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const wobserver_logger_1 = __importDefault(__webpack_require__(/*! ../wobserver.logger */ "./build/wobserver.logger/index.js"));
const interval_worker_1 = __importDefault(__webpack_require__(/*! ./interval.worker */ "./build/wobserver.core/interval.worker/index.js"));
const pc_manager_1 = __importDefault(__webpack_require__(/*! ./pc.manager */ "./build/wobserver.core/pc.manager/index.js"));
class Wobserver {
    constructor() {
        this.pcManager = new pc_manager_1.default();
        this.intervalWorker = new interval_worker_1.default(1000);
        // todo add more logic here
        wobserver_logger_1.default.debug('initialized');
    }
    addPC(pc) {
...
exports.default = Wobserver;
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./build/wobserver.core/interval.worker/index.js":
/*!*******************************************************!*\
  !*** ./build/wobserver.core/interval.worker/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./build/wobserver.core/pc.manager/index.js":
/*!**************************************************!*\
  !*** ./build/wobserver.core/pc.manager/index.js ***!
  \**************************************************/
/*! no static exports found */
...
const wobserver_logger_1 = __importDefault(__webpack_require__(/*! ../../wobserver.logger */ "./build/wobserver.logger/index.js"));
const wobserver_pc_1 = __importDefault(__webpack_require__(/*! ./wobserver.pc */ "./build/wobserver.core/pc.manager/wobserver.pc/index.js"));
class PCManager {
    constructor() {
        this.pcList = [];
        this.plugins = [];
    ...
    addPC(pc) {
        const curPC = new wobserver_pc_1.default(uuid_1.v4(), pc);
        this.pcList.push(curPC);
    }
    attachPlugin(plugin) {
        // if this plugin already attached omit
        if (this.plugins.find(item => item.id === plugin.id)) {
            wobserver_logger_1.default.warn('this plugin already attached. omitting re-adding!');
            return;
        }
    ...
    worker() {
        for (const curPc of this.pcList) {
            curPc.execute(this.plugins).catch(err => wobserver_logger_1.default.error(err));
        }
    }
    dispose() {
        for (const curPc of this.pcList) {
            curPc === null || curPc === void 0 ? void 0 : curPc.dispose();
        }
        this.pcList = [];
        this.plugins = [];
    }
}
exports.default = PCManager;
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./build/wobserver.core/pc.manager/wobserver.pc/index.js":
/*!***************************************************************!*\
  !*** ./build/wobserver.core/pc.manager/wobserver.pc/index.js ***!
  \***************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const stats_parser_1 = __importDefault(__webpack_require__(/*! ../../../wobserver.plugins/stats.parser */ "./build/wobserver.plugins/stats.parser/index.js"));
const queue_1 = __importDefault(__webpack_require__(/*! ../../wobserver.datastructure/queue */ "./build/wobserver.core/wobserver.datastructure/queue/index.js"));
class WobserverPC {
    constructor(id, pc) {
        this.statsQueue = new queue_1.default();
        this.id = id;
        this.pc = pc;
    }
    getPc() {
    ...
    execute(pluginList) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const curPlugin of pluginList) {
                const result = yield (curPlugin === null || curPlugin === void 0 ? void 0 : curPlugin.execute(this));
                if (curPlugin instanceof stats_parser_1.default && result) {
...
exports.default = WobserverPC;
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./build/wobserver.core/wobserver.datastructure/queue/index.js":
/*!*********************************************************************!*\
  !*** ./build/wobserver.core/wobserver.datastructure/queue/index.js ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./build/wobserver.logger/index.js":
/*!*****************************************!*\
  !*** ./build/wobserver.logger/index.js ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./build/wobserver.plugins/index.js":
/*!******************************************!*\
  !*** ./build/wobserver.plugins/index.js ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.WobserverPlugin = void 0;
const uuid_1 = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/esm-browser/index.js");
class WobserverPlugin {
    constructor() {
        this.id = uuid_1.v4();
    }
}
exports.WobserverPlugin = WobserverPlugin;
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./build/wobserver.plugins/stats.parser/index.js":
/*!*******************************************************!*\
  !*** ./build/wobserver.plugins/stats.parser/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const index_1 = __webpack_require__(/*! ../index */ "./build/wobserver.plugins/index.js");
class StatsParser extends index_1.WobserverPlugin {
    constructor() {
        super(...arguments);
        this.blackList = ['certificate', 'codec', 'transport', 'local-candidate', 'remote-candidate', 'candidate-pair'];
    }
    execute(wobserverPC) {
        return __awaiter(this, void 0, void 0, function* () {
            const [rawReceiverStats, rawSenderStats] = yield Promise.all([
                this.receiverStats(wobserverPC === null || wobserverPC === void 0 ? void 0 : wobserverPC.getPc()),
                this.senderStats(wobserverPC === null || wobserverPC === void 0 ? void 0 : wobserverPC.getPc())
            ]);
            const iceStats = yield this.getIceStats(rawReceiverStats, rawSenderStats);
            const receiverStats = yield this.filterStats(rawReceiverStats);
            const senderStats = yield this.filterStats(rawSenderStats);
            return {
                iceStats,
                receiverStats,
                senderStats,
    ...
    receiverStats(pc) {
        return __awaiter(this, void 0, void 0, function* () {
            const receivers = pc === null || pc === void 0 ? void 0 : pc.getReceivers();
            if (!receivers) {
                return;
            }
            const statsList = [];
            for (const curReceiver of receivers) {
                const stats = yield curReceiver.getStats();
    ...
    senderStats(pc) {
        return __awaiter(this, void 0, void 0, function* () {
            const senders = pc === null || pc === void 0 ? void 0 : pc.getSenders();
            if (!senders) {
                return;
            }
            const statsList = [];
            for (const curSender of senders) {
                const stats = yield curSender.getStats();
                for (const value of stats === null || stats === void 0 ? void 0 : stats.values()) {
                    statsList.push(value);
                }
            }
    ...
    getIceStats(receiverStats, senderStats) {
        return __awaiter(this, void 0, void 0, function* () {
            const localCandidates = receiverStats.filter((item) => 'local-candidate' === item.type);
            const remoteCandidates = receiverStats.filter((item) => 'remote-candidate' === item.type);
            const iceCandidatePair = receiverStats.filter((item) => 'candidate-pair' === item.type);
            return {
                iceCandidatePair,
                localCandidates,
                remoteCandidates,
    ...
    filterStats(statsList) {
        return statsList.filter((item) => !this.blackList.includes(item === null || item === void 0 ? void 0 : item.type));
    }
}
...
/***/ "./build/wobserver.plugins/stats.sender/index.js":
/*!*******************************************************!*\
  !*** ./build/wobserver.plugins/stats.sender/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
const wobserver_logger_1 = __importDefault(__webpack_require__(/*! ../../wobserver.logger */ "./build/wobserver.logger/index.js"));
const index_1 = __webpack_require__(/*! ../index */ "./build/wobserver.plugins/index.js");
class StatsSender extends index_1.WobserverPlugin {
    ...
    sendMessage(samples) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            wobserver_logger_1.default.warn('sending samples to server', samples);
...
/******/ })["default"];
//# sourceMappingURL=webextrapp-lib.js.map